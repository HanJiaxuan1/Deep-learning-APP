...
Second step: Download the Docker Desktop and open it  (Make sure you have an image in docker before you run the project to ensure that python interacts correctly with the Docker Desktop)   (Note: When you upload your models, Sud.DL requires you to have enough disk space to store the virtual environment, usually 10 GB per model, so make sure you have enough space to avoid bug).
